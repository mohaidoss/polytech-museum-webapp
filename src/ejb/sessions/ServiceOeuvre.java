...
public interface ServiceOeuvre {
	...
	//Administrateur
	public void creerOeuvre(int Id,String URL,String titre,int annee,TypeOeuvre type, int artiste_num) throws OeuvreDejaCreeException;
	...
	public enum TypeOeuvre {PEINTURE, PHOTO,SCULPTURE};
